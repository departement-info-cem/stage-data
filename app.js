class DataVisualizationApp {
  ...
  getSampleData(filePath) {
      // Données d'exemple correspondant exactement à votre format
      if (filePath.includes('techno.csv')) {
          return `Quels langages as-tu utilisés ?
C#;CSS;HTML;JavaScript;SQL;
Python;Bash / Shell;
C#;JavaScript;Python;
C#;CSS;Dart;HTML;JavaScript;SQL;TypeScript;TSQL;
JavaScript;Python;HTML;CSS;
C#;SQL;JavaScript;
Python;JavaScript;TypeScript;HTML;
CSS;HTML;JavaScript;React;
C#;Python;SQL;JavaScript;HTML;
